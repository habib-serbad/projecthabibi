"""
Django settings for projecthabib project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-nxzjg@evg8zs&0mns(g98n3%s_b78^6epc4qh+62ak$*np0cgb')
...
ROOT_URLCONF = 'projecthabib.urls'
...
WSGI_APPLICATION = 'projecthabib.wsgi.application'
